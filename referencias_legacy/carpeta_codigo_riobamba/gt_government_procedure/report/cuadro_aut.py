...
class requisitionCuadroAut(report_sxw.rml_parse):
    def __init__(self, cr, uid, name, context):
        super(requisitionCuadroAut, self).__init__(cr, uid, name, context=context)
...
report_sxw.report_sxw('report.purchase.req.cuadro.aut','purchase.requisition','addons/gt_government_procedure/report/cuadro_aut.rml',parser=requisitionCuadroAut)
