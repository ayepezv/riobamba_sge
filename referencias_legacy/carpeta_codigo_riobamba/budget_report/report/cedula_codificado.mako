...
<table cellspacing="0" cellpadding="1" WIDTH="100%">
  <tr>
    <td style="font-size:12px" align="center" WIDTH="85%"><b>PROFORMA PRESUPUESTARIA DE INGRESOS CODIFICADO</b></td>    
  </tr>   
</table>	
<p></p>
<table WIDTH="100%" border="1" cellpadding="2" cellspacing="0"  bordercolor="#000000" style="border-collapse:collapse;font-size:10px">
  ...
  %if values['padre'] and values['code']!=0 and values['code']!='0' and (values['codif_amount']!=0):
  	%if values['final']:
