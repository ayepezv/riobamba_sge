<html>
  ...
  <%
     a+=1
     %>
    <H2><center>ACTA DE ENTREGA RECEPCION INICIAL DE BIENES ${inv.secuencia or ''|entity}</center></H2>
    <p style="font-size:12px;text-align: justify"> En el Cant&oacute;n de ${user.company_id.city or ''|entity}, Provincia de/del ${user.company_id.state_id.name or ''|entity}, a los ${ inv.date_entrega or ''}, en las oficinas de ${user.context_department_id.name or ''|entity}, de el ${user.company_id.name or ''|entity}, se re&uacute;nen por una parte ${user.context_department_id.coordinador_id.complete_name or ''|entity}, en calidad de ${user.context_department_id.coordinador_id.job_id.name or ''|entity}, y por otra, ${inv.employee_id.complete_name or ''|entity}, con el fin de realizar la entrega recepci&oacute;n de los bienes que se detallan a continuaci&oacute;n, conforme lo indica el Art. 3 del Reglamento General para la Administración, Utilización y Control de los Bienes y Existencias del Sector Público.</p>
    <br>
    <br>
