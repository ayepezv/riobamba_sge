...
<body style="overflow:visible;">	
  ...
  <tr style="border: 1px solid black;"><h4 style="text-align:center;" align="center">ROL RETENCIONES JUDICIALES DECIMO CUARTO - SUPA ${decimo.contract_type.name} DEL: ${decimo.period_start.date_start} -  ${decimo.period_end.date_stop}</h4></tr>
  <%
     a=total=0
     %>
