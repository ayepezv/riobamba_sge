...
<body style="overflow:visible;">	
  ...
  <tr style="border: 1px solid black;"><h4 style="text-align:center;" align="center">ROL RETENCIONES JUDICIALES DECIMO CUARTO ${decimo.contract_type.name} DEL: ${decimo.date_start} -  ${decimo.date_stop}</h4></tr>
  <%
     a=total=0
     %>
