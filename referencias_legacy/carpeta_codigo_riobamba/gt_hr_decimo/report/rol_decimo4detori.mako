...
<body style="overflow:visible;">
  <%
	...
	<th style="font-size:10px" width="5%">Total Dias Lab.</th>
    ...
    <tr style="border: 1px solid black; page-break-inside: avoid;">
      ...
      <th style="font-size:10px;text-align:right" width="5%">${decimo_id.dias_lab}</th>   
    ...
    <tr style="border: 1px solid black; page-break-inside: avoid;">
      ...
      <th style="font-size:10px" width="5%">${ '{:,.2f}'.format(total)}</th>
      <th style="font-size:10px" width="5%"></th>
      <th style="font-size:10px" width="5%"></th>
    </tr>
    %endfor
...
%endfor
    ...
    <tr style="border: 1px solid black; page-break-inside: avoid;">
      <th style="font-size:10px" width="5%"></th>
      <th style="font-size:10px" width="10%">TOTAL DECIMO CUARTO</th>
