...
<body style="overflow:visible;">	
  ...
  <tr style="border: 1px solid black;"><h4 style="text-align:center;" align="center">ROL RETENCIONES JUDICIALES DECIMO TERCERO ${decimo.contract_type.name} DEL: ${decimo.period_start.date_start} -  ${decimo.period_end.date_stop}</h4></tr>
  <%
     a=total=0
     %>
  ...
  <table WIDTH="100%" border="1" cellpadding="2" cellspacing="0"  bordercolor="#000000" style="border-collapse:collapse;font-size:12px">
    <tr style="border-collapse:collapse;font-size:12px">
      ...
      <th style="font-size:11px" width="50%">TOTAL RETENIDO JUDICIAL DECIMO TERCERO</th>
