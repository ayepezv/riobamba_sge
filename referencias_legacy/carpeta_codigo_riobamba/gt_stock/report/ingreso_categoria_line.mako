...
<head>
 ...
 <body>
   ...
   <table class="table_basic table_title">
     <tr>
       <td>CATEGORIA: ${line.categ_id.name}</td>
     </tr>
   </table>
   <table WIDTH="100%" border="1" cellpadding="2" cellspacing="0"  bordercolor="#000000" style="border-collapse:collapse;font-size:12px">
    ...
    <tr style="page-break-inside:avoid">
      <td width="80%" style="font-size:11px;text-align:left">${line_line.product_id.name}</td>
   ...
   %endfor
    <tr style="page-break-inside:avoid">
      <td width="80%" style="font-size:11px;text-align:right"><b>${}</b></td>
      <td width="10%" style="font-size:11px;text-align:right"><b>TOTAL</b></td>
      <td width="10%" style="font-size:11px;text-align:right"><b>${total_all}</b></td>
    </tr>
   %endfor
</table>
