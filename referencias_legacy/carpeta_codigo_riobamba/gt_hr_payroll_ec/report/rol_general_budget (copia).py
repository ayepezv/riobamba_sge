                ...
                for rubro in rol_individual.line_ids:#payslip lines
                    if diccionario.has_key(rol_individual.contract_id.program_id.id):
                      if diccionario[rol_individual.contract_id.program_id.id].has_key(dept_id):
                        if diccionario[rol_individual.contract_id.program_id.id][dept_id].has_key(rol_individual.contract_id.budget_ind):
                            if not rubro.salary_rule_id.agrupar:
                                if diccionario[rol_individual.contract_id.program_id.id][dept_id][rol_individual.contract_id.budget_ind].has_key(rubro.salary_rule_id.id):
                                    diccionario[rol_individual.contract_id.program_id.id][dept_id][rol_individual.contract_id.budget_ind][rubro.salary_rule_id.id] += rubro.amount
                                else:
                                    diccionario[rol_individual.contract_id.program_id.id][dept_id][rol_individual.contract_id.budget_ind][rubro.salary_rule_id.id] = rubro.amount
                            else:
                                ...
                                if diccionario[rol_individual.contract_id.program_id.id][dept_id][rol_individual.contract_id.budget_ind].has_key(rubro_aux.id):
                                    diccionario[rol_individual.contract_id.program_id.id][dept_id][rol_individual.contract_id.budget_ind][rubro_aux.id] += rubro.amount
                                else:
                                    diccionario[rol_individual.contract_id.program_id.id][dept_id][rol_individual.contract_id.budget_ind][rubro_aux.id] = rubro.amount
                        else:
                            diccionario[rol_individual.contract_id.program_id.id][dept_id][rol_individual.contract_id.budget_ind] = {'nombre':rol_individual.employee_id.complete_name,'cedula': rol_individual.employee_id.name, 'tipo cuenta': (rol_individual.employee_id.bank_account_id and rol_individual.employee_id.bank_account_id.type_cta or '-'), 'numero cuenta': (rol_individual.employee_id.bank_account_id and rol_individual.employee_id.bank_account_id.acc_number or '-'), 'partida': (rol_individual.contract_id.budget_ind and rol_individual.contract_id.budget_ind or '-'), rubro.salary_rule_id.id: rubro.amount}
                      else:
                        diccionario[rol_individual.contract_id.program_id.id][dept_id] = {rol_individual.contract_id.budget_ind: {'nombre':rol_individual.employee_id.complete_name,'cedula': rol_individual.employee_id.name, 'tipo cuenta': (rol_individual.employee_id.bank_account_id and rol_individual.employee_id.bank_account_id.type_cta or '-'), 'numero cuenta': (rol_individual.employee_id.bank_account_id and rol_individual.employee_id.bank_account_id.acc_number or '-'), 'partida': (rol_individual.contract_id.budget_ind and rol_individual.contract_id.budget_ind or '-'), rubro.salary_rule_id.id: rubro.amount}}
                    else:
                        diccionario[rol_individual.contract_id.program_id.id] ={dept_id: {rol_individual.employee_id.contract_id.budget_ind: {'nombre':rol_individual.employee_id.complete_name,'cedula': rol_individual.employee_id.name, 'tipo cuenta': (rol_individual.employee_id.bank_account_id and rol_individual.employee_id.bank_account_id.type_cta or '-'), 'numero cuenta': (rol_individual.employee_id.bank_account_id and rol_individual.employee_id.bank_account_id.acc_number or '-'), 'partida': (rol_individual.contract_id.budget_ind and rol_individual.contract_id.budget_ind or '-'), rubro.salary_rule_id.id: rubro.amount}}}
                    ...
                    if rule_ids_tot_ing:
                        ...
                        diccionario[rol_individual.contract_id.program_id.id][dept_id][rol_individual.contract_id.budget_ind][rubro_aux_tot_ing.id] = rol_individual.aportable + rol_individual.allowance + rol_individual.basic
                    ...
                    if rule_ids_tot_egr:
                        ...
                        diccionario[rol_individual.contract_id.program_id.id][dept_id][rol_individual.contract_id.budget_ind][rubro_aux_tot_egr.id] = rol_individual.deduction
                    ...
                    if rule_ids_total:
                        ...
                        diccionario[rol_individual.contract_id.program_id.id][dept_id][rol_individual.contract_id.budget_ind][rubro_aux_total.id] = aux
        programa_clean = []
