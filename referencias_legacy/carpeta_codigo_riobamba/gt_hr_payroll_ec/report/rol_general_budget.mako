...
<!--tr style="border: 1px solid black;"><h5 style="text-align:center;" align="center">DESDE:  JULIO 2023  HASTA: NOVIEMBRE 2023</h5></tr-->
 <!tr style="border: 1px solid black;"><h2 style="text-align:center;" align="center">ROL DE PAGOS ${payroll.contract_type_id.name} DEL: ${payroll.period_id.name} </h\
1></tr>
...
%endfor
%if payroll.contract_type_id.name=='CONTRATO':
