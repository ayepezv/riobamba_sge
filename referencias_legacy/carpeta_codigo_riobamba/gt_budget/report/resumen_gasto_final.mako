...
%> 
  <table WIDTH="100%">
    ...
    <tr>
      <td width="100%" style="font-size:14;text-align:center;">RESUMEN DE GASTOS PROGRAMADOS FINAL ${o.poa_id.name or  ''}</td>	  	  
    </tr>
  </table>
<table cellspacing="0" cellpadding="1" WIDTH="100%">
  ...
  <table WIDTH="100%" border="1" cellpadding="2" cellspacing="0"  bordercolor="#000000" style="border-collapse:collapse;font-size:8px">
	...
	<%
	   ...
	   %>
    %for programa_id in get_programa_gp_final(o.poa_id):
	<%
	   aux_name=get_programa_name_final(programa_id)
	   aux_51 = get_budget_gp_final(programa_id,'51','0')
	   t_51 += aux_51
	   aux_53 = get_budget_gp_final(programa_id,'53','0')
	   t_53 += aux_53
	   aux_56 = get_budget_gp_final(programa_id,'56','57')
	   t_56 += aux_56
	   aux_58 = get_budget_gp_final(programa_id,'58','0')
	   t_58 += aux_58
	   subtot = aux_51 + aux_53 + aux_56 + aux_58
	   ts += subtot
	   aux_71 = get_budget_gp_final(programa_id,'71','0')
	   t_71 += aux_71
	   aux_73 = get_budget_gp_final(programa_id,'73','0')
	   t_73 += aux_73
	   aux_75 = get_budget_gp_final(programa_id,'75','0')
	   t_75 += aux_75
	   aux_77 = get_budget_gp_final(programa_id,'77','0')
	   t_77 += aux_77
	   aux_78 = get_budget_gp_final(programa_id,'78','0')
	   t_78 += aux_78
	   aux_84 = get_budget_gp_final(programa_id,'84','0')
	   t_84 += aux_84
	   aux_87 = get_budget_gp_final(programa_id,'87','0')
	   t_87 += aux_87
	   aux_96 = get_budget_gp_final(programa_id,'96','0')
	   t_96 += aux_96
	   aux_97 = get_budget_gp_final(programa_id,'97','0')
	   t_97 += aux_97
