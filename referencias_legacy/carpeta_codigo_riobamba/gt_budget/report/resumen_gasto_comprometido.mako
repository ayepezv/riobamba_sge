...
%> 
  <table WIDTH="100%">
    ...
    <tr>
      <td width="100%" style="font-size:14;text-align:center;">RESUMEN DE GASTOS PROGRAMADOS COMPROMETIDO ${o.poa_id.name or  ''}</td>	  	  
    </tr>
  </table>
<table cellspacing="0" cellpadding="1" WIDTH="100%">
  ...
  <table WIDTH="100%" border="1" cellpadding="2" cellspacing="0"  bordercolor="#000000" style="border-collapse:collapse;font-size:8px">
	...
	<th style="font-size:12px" width="5%">Transf. Donac. Inv.</th>
        ...
        <th style="font-size:12px" width="5%">Apli. Finan.</th>
        <th style="font-size:12px" width="5%"></th>
        <th style="font-size:12px" width="5%"></th>
      </tr>
    </thead>
	<%
	   ...
	   %>
    %for programa_id in get_programa_gp_comprometido(o.poa_id):
	<%
	   aux_name=get_programa_name_comprometido(programa_id)
	   aux_51 = get_budget_gp_comprometido(programa_id,'51','0')
	   t_51 += aux_51
	   aux_53 = get_budget_gp_comprometido(programa_id,'53','0')
	   t_53 += aux_53
	   aux_56 = get_budget_gp_comprometido(programa_id,'56','57')
	   t_56 += aux_56
	   aux_58 = get_budget_gp_comprometido(programa_id,'58','0')
	   t_58 += aux_58
	   subtot = aux_51 + aux_53 + aux_56 + aux_58
	   ts += subtot
	   aux_71 = get_budget_gp_comprometido(programa_id,'71','0')
	   t_71 += aux_71
	   aux_73 = get_budget_gp_comprometido(programa_id,'73','0')
	   t_73 += aux_73
	   aux_75 = get_budget_gp_comprometido(programa_id,'75','0')
	   t_75 += aux_75
	   aux_77 = get_budget_gp_comprometido(programa_id,'77','0')
	   t_77 += aux_77
	   aux_78 = get_budget_gp_comprometido(programa_id,'78','0')
	   t_78 += aux_78
	   aux_84 = get_budget_gp_comprometido(programa_id,'84','0')
	   t_84 += aux_84
	   aux_87 = get_budget_gp_comprometido(programa_id,'87','0')
	   t_87 += aux_87
	   aux_96 = get_budget_gp_comprometido(programa_id,'96','0')
	   t_96 += aux_96
	   aux_97 = get_budget_gp_comprometido(programa_id,'97','0')
	   t_97 += aux_97
	   subtot2 = aux_71 + aux_73 + aux_75 + aux_77 + aux_84 + aux_87 + aux_96 + aux_97 + aux_78
	   ts2 += subtot2
    ...
    <tr style="page-break-inside:avoid">
      <%
	 tp_51 = tp_53 = tp_56 = tp_58 = tp_71 = tp_73 = tp_75 = tp_77 = tp_78 =tp_84 = tp_87 = tp_96 = tp_97 = stc = sti = t = 0
	 tp_51 = get_budget_gp_comprometido_field('51','0','codif_amount')
	 tp_53 = get_budget_gp_comprometido_field('53','0','codif_amount')
	 tp_56 = get_budget_gp_comprometido_field('56','57','codif_amount')
	 tp_58 = get_budget_gp_comprometido_field('58','0','codif_amount')
	 tp_71 = get_budget_gp_comprometido_field('71','0','codif_amount')
	 tp_73 = get_budget_gp_comprometido_field('73','0','codif_amount')
	 tp_75 = get_budget_gp_comprometido_field('75','0','codif_amount')
	 tp_77 = get_budget_gp_comprometido_field('77','0','codif_amount')
	 tp_78 = get_budget_gp_comprometido_field('78','0','codif_amount')
	 tp_84 = get_budget_gp_comprometido_field('84','0','codif_amount')
	 tp_87 = get_budget_gp_comprometido_field('87','0','codif_amount')
	 tp_96 = get_budget_gp_comprometido_field('96','0','codif_amount')
	 tp_97 = get_budget_gp_comprometido_field('97','0','codif_amount')
	 stc = tp_51 + tp_53 + tp_56 + tp_58
	 sti = tp_71 + tp_73 + tp_75 + tp_77 + tp_78 + tp_84 + tp_87 + tp_96 + tp_97
	 t = stc + sti
	 %>
      <th style="font-size:12px" width="15%"><b>Presupuestado</b></th>
      ...
      <td style="font-size:12px;text-align:right" width="5%">${ '{:,.2f}'.format(tp_78)}</td>
    ...
    <tr style="page-break-inside:avoid">
      <%
	 tpg_51 = tpg_53 = tpg_56 = tpg_58 = tpg_71 = tpg_73 = tpg_75 = tpg_77 = tpg_78 = tpg_84 = tpg_87 = tpg_96 = tpg_97 = stcg = stig = tg = 0
	 tpg_51 = get_budget_gp_comprometido_field('51','0','commited_amount')
	 tpg_53 = get_budget_gp_comprometido_field('53','0','commited_amount')
	 tpg_56 = get_budget_gp_comprometido_field('56','57','commited_amount')
	 tpg_58 = get_budget_gp_comprometido_field('58','0','commited_amount')
	 tpg_71 = get_budget_gp_comprometido_field('71','0','commited_amount')
	 tpg_73 = get_budget_gp_comprometido_field('73','0','commited_amount')
	 tpg_75 = get_budget_gp_comprometido_field('75','0','commited_amount')
	 tpg_77 = get_budget_gp_comprometido_field('77','0','commited_amount')
	 tpg_78 = get_budget_gp_comprometido_field('78','0','commited_amount')
	 tpg_84 = get_budget_gp_comprometido_field('84','0','commited_amount')
	 tpg_87 = get_budget_gp_comprometido_field('87','0','commited_amount')
	 tpg_96 = get_budget_gp_comprometido_field('96','0','commited_amount')
	 tpg_97 = get_budget_gp_comprometido_field('97','0','commited_amount')
	 stcg = tpg_51 + tpg_53 + tpg_56 + tpg_58
	 stig = tpg_71 + tpg_73 + tpg_75 + tpg_77 + tpg_78 + tpg_84 + tpg_87 +tpg_96 + tpg_97
	 tg = stcg + stig
	 %>
      <th style="font-size:12px" width="15%"><b>Comprometido</b></th>
      ...
      <td style="font-size:12px;text-align:right" width="5%">${ '{:,.2f}'.format(tpg_78)}</td>
    ...
    <tr style="page-break-inside:avoid">
      <%
	 tps_51 = tps_53 = tps_56 = tps_58 = tps_71 = tps_73 = tps_75 = tps_77 = tps_78 = tps_84 = tps_87 = tps_96 = tps_97 = stcs = stis = ts = 0
	 tps_51 = tp_51 - tpg_51
	 tps_53 = tp_53 - tpg_53
	 tps_56 = tp_56 - tpg_56
	 tps_58 = tp_58 - tpg_58
	 ...
	 stis = tps_71 + tps_73 + tps_75 + tps_77 + tps_78 + tps_84 + tps_87 + tps_96 + tps_97
	 ts = stcs + stis
	 %>
      <th style="font-size:12px;text-align:right" width="15%"><b>Saldo</b></th>
      ...
      <th style="font-size:12px;text-align:right" width="5%">${ '{:,.2f}'.format(tps_78)}</th>
