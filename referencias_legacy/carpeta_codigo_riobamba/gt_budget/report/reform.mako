...
<H5><left>PARTIDAS ORIGEN o DISMINUCION</center></H5>
%if o.line_ids:
...
<table WIDTH="100%" border="1" cellpadding="2" cellspacing="0"  bordercolor="#000000" style="border-collapse:collapse;font-size:8px">
  ...
  <tr style="page-break-inside:avoid">
    ...
    <td width="9%" style="font-size:8px;text-align:right">${'{:,.2f}'.format(0)}</td>
    %if line.traspaso:
  ...
  <tr style="page-break-inside:avoid">
    ...
    <td width="9%" style="font-size:8px;text-align:right"><b>${'{:,.2f}'.format(0)}</b></td>
    %if line.traspaso:
...
<table WIDTH="100%" border="1" cellpadding="2" cellspacing="0"  bordercolor="#000000" style="border-collapse:collapse;font-size:8px">
  ...
  <tr>
    <%
       aux_t = 0
       aux_t=o.inicial+o.tr_suma-o.tr_resta+o.aum_suma-o.dis_suma
       %>
    <th style="font-size:8px" width="15%"></th>
    ...
    <th style="font-size:8px" width="9%">${'{:,.2f}'.format(aux_t)}</th>
  </tr>
</table>
</body>
