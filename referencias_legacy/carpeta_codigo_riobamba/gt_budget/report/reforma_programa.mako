...
<H4><left>ASIGNACION SEGUN EL OBJETO DEL GASTO</center></H4>
...
<table WIDTH="100%" border="1" cellpadding="2" cellspacing="0"  bordercolor="#000000" style="border-collapse:collapse;font-size:8px">
  ...
  <% 
     finalt = final2t = t_init = t_aut = t_dist = t_supt = t_redt = aux_total_final = 0 
     %>
  %for programa_id in get_programa_reforma(o):
  <%
...
<table WIDTH="100%" border="1" cellpadding="2" cellspacing="0"  bordercolor="#000000" style="border-collapse:collapse;font-size:8px">
  ...
  <H6><left>${aux_name}</center></H6>
  %for line in get_line_ids(programa_id,o):
  <% 
     final1 = line.final
     final2 += final1
     t_ini += line.inicial
  ...
  <tr style="page-break-inside:avoid">
    ...
    <td width="9%" style="font-size:8px;text-align:right">${'{:,.2f}'.format(line.inicial)}</td>
  ...
  %if len(o.line_ids)>0:
  <tr style="page-break-inside:avoid">
    <td width="15%" style="font-size:8px;text-align:center"><b>SUBTOTAL PROGRAMA</b></td>
...
<table WIDTH="100%" border="1" cellpadding="2" cellspacing="0"  bordercolor="#000000" style="border-collapse:collapse;font-size:8px">
  <tr style="page-break-inside:avoid">
    <td width="15%" style="font-size:8px;text-align:center"><b>TOTAL ORIGEN</b></td>
    <td width="31%" style="font-size:8px;text-align:left"></td>
    <td width="9%" style="font-size:8px;text-align:right"><b>${'{:,.2f}'.format(t_init)}</b></td>
    <td width="9%" style="font-size:8px;text-align:right"><b>${0}</b></td>
    <td width="9%" style="font-size:8px;text-align:right"><b>${'{:,.2f}'.format(t_aut)}</b></td>
    <td width="9%" style="font-size:8px;text-align:right"><b>${0}</b></td>
    <td width="9%" style="font-size:8px;text-align:right"><b>${'{:,.2f}'.format(t_redt)}</b></td>
    <td width="9%" style="font-size:8px;text-align:right"><b>${'{:,.2f}'.format(final2t)}</b></td>
  </tr>
</table>
...
<table WIDTH="100%" border="1" cellpadding="2" cellspacing="0"  bordercolor="#000000" style="border-collapse:collapse;font-size:8px">
  ...
  <% 
     final1t = final2t = t_init_2t = t_aut_2t = t_red_2t =  0 
     %>
  %for programa_id in get_programa_reforma2(o):
  <%
     aux_name=get_programa_name(programa_id)
     %>
<table WIDTH="100%" border="1" cellpadding="2" cellspacing="0"  bordercolor="#000000" style="border-collapse:collapse;font-size:8px">
  ...
  <% 
     ...
     %>
  <H6><left>${aux_name}</center></H6>
  %for line in get_line_ids2(programa_id,o):
  <%
     final = line.final
     final2 += line.final
     t_ini_2 += line.inicial
     if line.traspaso:
         t_au_2 += line.monto
     else:
         t_red_2 += line.monto
...
<table WIDTH="100%" border="1" cellpadding="2" cellspacing="0"  bordercolor="#000000" style="border-collapse:collapse;font-size:8px">
  <tr style="page-break-inside:avoid">
    <td width="15%" style="font-size:8px;text-align:center"><b>TOTAL DESTINO</b></td>
    <td width="31%" style="font-size:8px;text-align:left"></td>
    <td width="9%" style="font-size:8px;text-align:right"><b>${'{:,.2f}'.format(t_init_2t)}</b></td>
    <td width="9%" style="font-size:8px;text-align:right"><b>${'{:,.2f}'.format(t_aut_2t)}</b></td>
    <td width="9%" style="font-size:8px;text-align:right"><b>${0}</b></td>
    <td width="9%" style="font-size:8px;text-align:right"><b>${'{:,.2f}'.format(t_red_2t)}</b></td>
    <td width="9%" style="font-size:8px;text-align:right"><b>${0}</b></td>
    <td width="9%" style="font-size:8px;text-align:right"><b>${'{:,.2f}'.format(final2t)}</b></td>
  </tr>
</table>
...
<table WIDTH="100%" border="1" cellpadding="2" cellspacing="0"  bordercolor="#000000" style="border-collapse:collapse;font-size:8px">
  ...
  <tr>
    <%
       aux_total_final = o.inicial + o.tr_suma - o.tr_resta + o.aum_suma - o.dis_suma
       %>
    <th style="font-size:8px" width="15%"></th>
    ...
    <th style="font-size:8px" width="9%">${'{:,.2f}'.format(aux_total_final)}</th>
  </tr>
</table>
</body>
