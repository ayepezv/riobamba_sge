...
<body>
  <table WIDTH="100%">
	<tr>
	  <td width="100%" style="font-size:14;text-align:center;">DETALLE ACTUAL</td>	  	  
    </tr>	
  </table>
  <p></p>
  <table WIDTH="100%" border="1" cellpadding="2" cellspacing="0"  bordercolor="#000000" style="border-collapse:collapse;font-size:12px">
	...
	<%
	   a+=1
	   total+=abs(inv.debit-inv.credit)
	   %>
    <tr style="page-break-inside:avoid">
      <td width="5%" style="font-size:11px;text-align:center">${a}</td>
      <td width="30%" style="font-size:11px;text-align:center">${inv.partner_id.name}</td>
      <td width="40%" style="font-size:11px;text-align:center">${inv.move_id.narration}</td>
      ...
      <td width="5%" style="font-size:11px;text-align:right">${inv.move_id.name}</td>
      <td width="10%" style="font-size:11px;text-align:right">${abs(inv.debit-inv.credit)}</td>
    </tr>
    %endfor
  </table>
    <table>
