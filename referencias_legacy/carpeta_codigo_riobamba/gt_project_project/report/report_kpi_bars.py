...
class ProjectReportKpiBars(report_sxw.rml_parse):
    def __init__(self, cr, uid, name, context):
        super(ProjectReportKpiBars, self).__init__(cr, uid, name, context=context)
...
report_sxw.report_sxw('report.project_report_kpi_bars',
                       'project.project', 
                       'addons/gt_project_project/report/project_report_kpi_bars.mako',
                       parser=ProjectReportKpiBars)
