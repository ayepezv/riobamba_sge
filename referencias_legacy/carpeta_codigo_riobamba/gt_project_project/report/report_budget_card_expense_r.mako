...
<table WIDTH="100%" border="1" cellpadding="2" cellspacing="0"  bordercolor="#000000" style="border-collapse:collapse;font-size:10px">
  <thead style="display: table-header-group" BGCOLOR="#D8D8D8">   
      ...
      <th align="center" style="font-size:9px" WIDTH="7%">ASIGNACION INCIAL <br>(A)</th>
  </thead>
  ...
  %if vars['tipo_nivel']=='p':
      ...
      <tr style="border: 1px solid black; page-break-inside: avoid;">
        <td WIDTH="7%" align="left">${ values['code_report']}</td>
  ...
  %endfor
      <%
	 aux_total_presupuesto += res['total']['planned_amount']
	 %>
...
<table WIDTH="100%" border="1" cellpadding="2" cellspacing="0"  bordercolor="#000000" style="border-collapse:collapse;font-size:10px">
  ...
  <td WIDTH="7%" style="font-weight: bold;font-size:11px" align="right">${'{:,.2f}'.format(aux_total_presupuesto)}</td>
  <tfoot>
</table>
%endfor
</body>
