...
class evaluacion_pgasto(report_sxw.rml_parse):
    def __init__(self, cr, uid, name, context=None):
        super(evaluacion_pgasto, self).__init__(cr, uid, name, context=context)
    ...
    def set_context(self, objects, data, ids, report_type=None):
        ...
        if ids_lines:
            ...
            return super(evaluacion_pgasto, self).set_context([objects], data, ids, report_type=report_type)
        else:
...
report_sxw.report_sxw('report.evaluacion_pgasto','evaluacion.budget',
                      'gt_project_project/report/evaluacion_pgasto.mako',
                      parser=evaluacion_pgasto)
