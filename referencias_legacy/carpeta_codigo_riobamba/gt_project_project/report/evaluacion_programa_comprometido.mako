...
<tr style="border: 1px solid black; page-break-inside: avoid;font-size:14px">
    <%
       por_pagado = por_pagado_mes = saldo_acumulado = por_saldo = 0
    ...
    <td WIDTH="8%" style="font-weight: bold;font-size:18px" align="right">${'{:,.2f}'.format(res['total']['commited_amount_mes'])}</td>    
    <td WIDTH="4%" style="font-weight: bold;font-size:18px" align="right">${'{:,.2f}'.format(por_pagado_mes)}</td>    
    <td WIDTH="8%" style="font-weight: bold;font-size:18px" align="right">${'{:,.2f}'.format(res['total']['commited_amount'])}</td>    
...
<tr style="border: 1px solid black; page-break-inside: avoid;font-size:14px">
    ...
    %if abs(res_f[1])>0.01:
    <td WIDTH="9%" style="font-weight: bold;font-size:18px" align="right">${'{:,.2f}'.format(res_f[1])}</td>
    %else:
...
<tr style="border: 1px solid black; page-break-inside: avoid;font-size:14px">
    ...
    %if abs(res_e[1])>0.01:
    <td WIDTH="9%" style="font-weight: bold;font-size:18px" align="right">${'{:,.2f}'.format(res_e[1])}</td>
    %else:
    <td WIDTH="9%" style="font-weight: bold;font-size:18px" align="right">${'{:,.2f}'.format(0)}</td>
    %endif
