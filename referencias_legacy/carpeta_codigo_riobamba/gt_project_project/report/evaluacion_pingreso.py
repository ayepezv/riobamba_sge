...
class evaluacion_pingreso(report_sxw.rml_parse):
    def __init__(self, cr, uid, name, context=None):
        super(evaluacion_pingreso, self).__init__(cr, uid, name, context=context)
    ...
    def set_context(self, objects, data, ids, report_type=None):
        ...
        if ids_lines:
            ...
            return super(evaluacion_pingreso, self).set_context([objects], data, ids, report_type=report_type)
        else:
...
report_sxw.report_sxw('report.evaluacion_pingreso','evaluacion.budgeti',
                      'gt_project_project/report/evaluacion_pingreso.mako',
                      parser=evaluacion_pingreso)
