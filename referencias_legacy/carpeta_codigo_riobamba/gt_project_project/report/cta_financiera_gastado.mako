...
%> 
  <table WIDTH="100%">
    <tr>
      <td width="100%" style="font-size:18;text-align:center;">CUENTA FINANCIERA ENTRE INGRESOS Y GASTOS GASTADO EJECUTADO DEL ${o.name or  ''} : ${o.tipo or  ''}</td>
    </tr>
    <tr>
...
<table cellspacing="0" cellpadding="1" WIDTH="100%">
  ...
  <table WIDTH="100%" border="1" cellpadding="2" cellspacing="0"  bordercolor="#000000" style="border-collapse:collapse;font-size:16px">
	...
	<th style="font-size:16px" width="5%">Codigo</th>
        ...
        <th style="font-size:16px" width="8%">Gastos</th>
    ...
    <%
       ...
       %>
    <tr style="page-break-inside:avoid">
      <td width="5%" style="font-size:16px;text-align:center"></td>
