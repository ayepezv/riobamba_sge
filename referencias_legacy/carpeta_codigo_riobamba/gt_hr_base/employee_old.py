...
class hrAccionPersonal(osv.Model):
    ...
    _columns = dict(
        ...
        tipo = fields.selection([('Ingreso','Ingreso'),('Nombramiento','Nombramiento'),('Ascenso','Ascenso'),('Nombramiento Provisional','Nombramiento Provisional'),
                                 ('Libre Nombramiento o Remocion','Libre Nombramiento o Remocion'),('Actualizacion','Actualizacion',),
