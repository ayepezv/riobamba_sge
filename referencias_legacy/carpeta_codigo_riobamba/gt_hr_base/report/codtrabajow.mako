...
El ${user.company_id.name} para el cumplimiento de sus actividades y desarrollo de las tareas propias de su actividad; y, del análisis realizado por la Unidad de Administración del Talento Humano al desempeño de las funciones del personal que se encuentra laborando en esta municipalidad, se infiere la necesidad indispensable de contratar a un ${o.contract_id.employee_id.job_id.name}. ${o.contract_id.employee_id.complete_name} declara tener los conocimientos y capacidades necesarios para el desempeño del cargo indicado, por lo que en base a las consideraciones anteriores y por lo expresado en los numerales siguientes, el EMPLEADOR y el TRABAJADOR proceden a celebrar el presente contrato individual de trabajo a plazo fijo.
<P>
<b>TERCERA: OBJETO DEL CONTRATO.-</b>
${o.contract_id.employee_id.complete_name} se compromete con el empleador a prestar sus servicios lícitos y personales en la clase de trabajo que le ha determinado la Unidad de Administración del Talento Humano en calidad de ${o.contract_id.employee_id.job_id.name}, para lo cual declara tener los conocimientos y capacidades necesarias, sus acciones serán supervisadas por el (Jefe Administrativo); y, cumplirá con las determinaciones descritas en el Art.80 referida en la Ordenanza de Clasificación y Valoración de Puestos, Reglamento Orgánico Funcional, Organigrama Estructural y Manual de Funciones, publicada en el Edición Especial del Registro Oficial Nº.99 de martes 10 de Febrero del 2009 y su reforma.
<P>
<BR>
