...
<table cellspacing="0" cellpadding="1" WIDTH="100%">
  <tr>
    <td style="font-size:12px" align="center" WIDTH="85%">PRESUPUESTO APROBADO POR CONCEJO GASTOS</td>    
  </tr>   
  <tr>
    <td style="font-size:11px" align="left" WIDTH="85%">PROGRAMA: ${o.program_id.sequence} - ${o.program_id.name}</td>    
  </tr>   
  <tr>
    <td style="font-size:11px" align="left" WIDTH="85%">PRESUPUESTO: ${o.budget_id.name.name}</td>    
  </tr>   
</table>	
<p></p>
<table WIDTH="100%" border="1" cellpadding="2" cellspacing="0"  bordercolor="#000000" style="border-collapse:collapse;font-size:10px">
  ...
  %if values.has_key('general_budget_name') and values['code']!='0':
