...
<table cellspacing="0" cellpadding="0" WIDTH="100%">
  <tr>
    <th style="font-size:18px" WIDTH="100%">EVALUACION PRESUPUESTARIA FUENTE DE FINANCIAMIENTO COMPROMETIDO</th>
  </tr>  
</table>
<p></p>
<table WIDTH="100%" border="1" cellpadding="2" cellspacing="0"  bordercolor="#000000" style="border-collapse:collapse;font-size:16px">
  <thead style="display: table-header-group" BGCOLOR="#D8D8D8">   
    ...
    <tr>
      ...
      <td align="center" style="font-size:16px" WIDTH="7%">COMPROMETIDO</td>
      <td align="center" style="font-size:16px" WIDTH="7%">% COMPROMETIDO</td>
  ...
  <tr style="border: 1px solid black; page-break-inside: avoid;">
    ...
    <td style="font-size:18px" WIDTH="7%" align="right">${'{:,.2f}'.format(values['reform_amount'])}</td>
