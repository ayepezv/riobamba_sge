...
<body style="overflow:visible;">	
    ...
    <tr style="border: 1px solid black;"><h2 style="text-align:center;" align="center">ROL DE PAGOS ${payroll.contract_type_id.name} DEL: ${payroll.period_id.name} </h1></tr>
<!-- COLUMNA 1 -->
...
%if payroll.contract_type_id.name=='CONTRATO':
  <table width="100%" style="page-break-inside:avoid">
    ...
    <tr style="font-size:11px">
      ...
      <th width="33%">REVISION PROYECTOS</th>
    </tr>  
    <tr style="height:35px">
      <th></th>
      <th></th>
