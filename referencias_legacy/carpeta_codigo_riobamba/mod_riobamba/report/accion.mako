...
<body>
  ...
  <table WIDTH="100%" border='1' rules="cols" cellpadding="2" cellspacing="2"  bordercolor="#000000" >
    <tr>
      <td style="font-weight: bold;font-size:10px" width="10%">Tipo:</td>
      <td style="font-size:10px" width="25%">${o.tipo or ''}</td>
      <td style="font-weight: bold;font-size:10px" width="30%">Aut. Suscribe Acto Administrativo:</td>
      <td style="font-size:10px" width="40%">${o.autoridad_id.complete_name or ''}</td>
    </tr>
  </table>
  <p></p>
  <table WIDTH="100%" border='1' rules="cols" cellpadding="2" cellspacing="2"  bordercolor="#000000" >
  ...
  <table style="page-break-inside:avoid" width="100%" border='1' rules="cols" cellpadding="2" cellspacing="2"  bordercolor="#000000">
    ...
    <tr style="font-size:11px">
      <th width="100%" style="font-weight: bold;font-size:11px;text-align:center;">${o.autoridad_id.complete_name or ''}</th>
    </tr>
    <tr style="font-size:11px">
      <th width="100%" style="font-weight: bold;font-size:11px;text-align:center;">${o.autoridad_id.job_id.name or ''}</th>
    </tr>
    <tr style="font-size:11px">
      <th width="100%" style="font-weight: bold;font-color='white';font-size:11px;text-align:left;">.</th>
    </tr>
