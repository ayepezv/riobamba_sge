openerp.web_printscreen_zb = function(instance, m) {
	...
	on_loaded: function(data, grouped) {
		...
		header_eles = self.$element.find('.oe-listview-header-columns')
            header_name_list = []
            ...
            //Find Data Element
            data_eles = self.$element.find('.oe-listview-content > tbody > tr')
            export_data = []
            ...
            footer_eles = self.$element.find('.oe-listview-content > tfoot> tr')
