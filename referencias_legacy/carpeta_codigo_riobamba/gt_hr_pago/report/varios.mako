...
<head>
 ...
 <body>
   ...
   <%
     ...
     <table WIDTH="100%" border="1" cellpadding="2" cellspacing="0"  bordercolor="#000000" style="border-collapse:collapse;font-size:12px">
       <tr>
	 <td width="5%" type="a" style="font-size:11px;text-align:center">${a}</td>
	 %if line.descontado_id:
	 <td width="65%" style="font-size:11px;text-align:left">${line.descontado_id.complete_name}:- ${line.name.name} - ${line.name.ced_ruc}</td>
	 %else:
