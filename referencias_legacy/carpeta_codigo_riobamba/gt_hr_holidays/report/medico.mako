...
<body>
  ...
  <table WIDTH="100%">
    <tr>
      <td width="100%" style="font-size:14;text-align:center;">CERTIFICADO MEDICO</td>	  	  
    </tr>	
  </table>
  <table WIDTH="100%" border='1' rules="cols" cellpadding="2" cellspacing="2"  bordercolor="#000000" >  
    ...
    <tr>
      <td style="font-weight: bold;font-size:11px" width="12%">Instituto:</td>
      <td style="font-size:11px" width="42%">${o.institute_id.name or ''}</td>
    </tr> 
    <tr>
      <td style="font-weight: bold;font-size:11px" width="12%">Tipo Permiso:</td>
    ...
    %else:
    <tr>
      <td style="font-weight: bold;font-size:11px" width="12%">Hora Desde:</td>
      <td style="font-size:11px" width="42%">${o.hora_inicio or ''}</td>
    </tr> 
    <tr>
      <td style="font-weight: bold;font-size:11px" width="12%">Hora Hasta:</td>
      <td style="font-size:11px" width="42%">${o.hora_fin or ''}</td>
    </tr> 
    %endif
  </table>
  <p></p>
