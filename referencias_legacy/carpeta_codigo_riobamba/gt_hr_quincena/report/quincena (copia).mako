...
<head>
 ...
 <body>
   ...
   <h2 style="text-align:center;" align="center">NOMINA QUINCENAL DE OBREROS</h2>
   <%
       total=total_departamento=0
       %>
   ...
   <table WIDTH="100%" border="1" cellpadding="2" cellspacing="0"  bordercolor="#000000" style="border-collapse:collapse;font-size:12px">
     ...
     <table WIDTH="100%" border="1" cellpadding="2" cellspacing="0"  bordercolor="#000000" style="border-collapse:collapse;font-size:12px">
       <thead>
	 <tr>
	   <th width="35%" style="text-align:left;">Empleado</th>
     ...
     <table WIDTH="100%" border="1" cellpadding="2" cellspacing="0"  bordercolor="#000000" style="border-collapse:collapse;font-size:12px">
       <tr>
	 <td width="35%" style="font-size:11px;text-align:left">${line_line_line.employee_id.complete_name}</td>
	 <td width="35%" style="font-size:11px;text-align:right">${line_line_line.employee_id.job_id.name}</td>
...
<table WIDTH="100%" border="1" cellpadding="2" cellspacing="0"  bordercolor="#000000" style="border-collapse:collapse;font-size:12px">
  <tr>
    ...
    <td width="7%" style="font-size:11px;text-align:right"></td>
    <td width="7%" style="font-size:11px;text-align:right">TOTAL A PAGAR</td>
    <td width="7%" style="font-size:11px;text-align:right">${total}</td>
  </tr>
</table>
<table width="100%">
  <tr style="height:35px">
